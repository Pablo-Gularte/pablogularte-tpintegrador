...
SELECT Count(e.id_estudiante) estudiantes,
...
SELECT Count(e.id_estudiante) total_estudiantes,
       g.turno
FROM   estudiantes e
       JOIN grados g
         ON g.id_grado = e.id_grado
...
FROM   notas n
       ...
       JOIN asignaturas a
         ON a.id_asignatura = n.id_asignatura
WHERE  e.id_estudiante = 15
       AND n.anio = 2024
ORDER BY n.bimestre,
          e.id_estudiante,
